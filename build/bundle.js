...
exports.fetchLaunch = exports.FETCH_LAUNCH = undefined;
...
var FETCH_LAUNCH = exports.FETCH_LAUNCH = "fetch_launch";
var fetchLaunch = exports.fetchLaunch = function fetchLaunch(route) {
  return function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get("https://api.spacexdata.com/v3/launches" + route);
...
app.get("*", function (req, res) {
  ...
  var promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (r) {
...
function loadData(store, route) {
  return store.dispatch((0, _actions.fetchLaunch)(route.search));
}
...
exports.default = {
  loadData: loadData,
  component: (0, _reactRedux.connect)(mapStateToProps, { fetchLaunch: _actions.fetchLaunch })(Home)
};
...
var _launchesReducer = __webpack_require__(18);
